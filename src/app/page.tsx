        ...
        >
          <div className="grid grid-cols-form gap-3">
            ...
            <div className="grid grid-cols-2 gap-6">
              ...
              <Input.Root>
                <Input.Control defaultValue={'Campos'} />
              </Input.Root>
            </div>
          </div>
          ...
          <div className="grid grid-cols-form gap-3 pt-5">
            ...
            <Input.Root>
              ...
              <Input.Control
                type="email"
                id="email"
                defaultValue={'camposweb@gmail.com'}
              />
            </Input.Root>
          </div>
          ...
          <div className="grid grid-cols-form gap-3 pt-5">
            ...
            <div className="flex items-start gap-5">
              ...
              <label
                htmlFor="upload"
                className="flex-1 cursor-pointer flex-col items-center gap-3 rounded-lg border border-zinc-300 px-6 py-4 text-center text-zinc-500 shadow-sm"
              >
                select
              </label>
              <input type="file" id="upload" className="sr-only" />
            </div>
          </div>
          ...
          <div className="grid grid-cols-form gap-3 pt-5">
            ...
            <Input.Root>
              <Input.Control type="text" id="role" defaultValue={'CTO'} />
            </Input.Root>
          </div>
